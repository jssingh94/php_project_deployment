...
<div class="col-md-2">
<a href="#" style="border-radius:0%" class="pull-right btn sub1 title3" data-toggle="modal" data-target="#login"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>Admin Login</a></div>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-4">
		 <img src="image/CAM00121.jpg" width=100 height=100 alt="abc" class="img-rounded">
		 </div>
		 <div class="col-md-5">
     <a style="color:#202020; font-family:'typo' ; font-size:18px; text-decoration:none" title="Find on Facebook">abc</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+917785068889</h4>
		<h4 style="font-family:'typo' ">abc@gmail.com</h4>
		<h4 style="font-family:'typo' ">xyz ,Sultanpur</h4></div></div>
		</p>
      </div>
